...
public class FirstPdf {
	...
	private static void addJobInfo(Document document, Building activeBuilding) throws DocumentException {
		...
		parThree.add(new Paragraph("Total Gain:  " + activeBuilding.getTotalGain(), summaryFont ));
		addEmptyLine(parThree, 1);
		parThree.add(new Paragraph("Total Loss:  "  +  activeBuilding.getTotalLoss(), summaryFont));
	...
	private static void addGain(Document doc, Building active, Chapter catPart){
		...
		table.addCell(""+active.getZoneData(z,11,0));
		table.addCell("  ");
		...
		Paragraph subgain = new Paragraph(""+active.getZoneData(z,12,3));
		Paragraph subloss = new Paragraph(""+active.getZoneData(z,26,3));
		...
		Paragraph gain = new Paragraph(""+active.getZoneData(z,12,3));
		Paragraph loss = new Paragraph(""+active.getZoneData(z,26,3));
